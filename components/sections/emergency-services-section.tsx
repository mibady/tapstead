        ...
        <Card className="bg-red-600 text-white">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-red-100 mb-6">
              For immediate emergency response after fires, storms, or disasters, call our 24/7 emergency line. 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <div className="text-red-100 text-sm">24/7 Support • Emergency teams deployed within 1-4 hours</div>
            </div>
          </CardContent>
        </Card>
